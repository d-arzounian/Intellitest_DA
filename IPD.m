...
%2I2AFC parameters
nb_essais_max = 150;
Tab_phase = zeros(nb_essais_max,1); % création tableau remplis de 0 à 1 colonne et autant de ligne que le nb d'essai max
...
if handles.Parametres.Aud
    ...
    set(handles.Sound2,'BackgroundColor',[240/255 240/255 240/255]) ;   drawnow;
    set(handles.text2,'string','Lequel des deux sons change de latéralisation?');
    end                    
    reponse_correcte = 2;
