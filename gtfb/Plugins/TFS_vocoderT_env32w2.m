function y=TFS_vocoderT_env32w2(x)
...
%%%vocoder 32
x_bdf=gammafilter(y,Den322,Num322,32);
x_bdf=real(gammasynth_m(deltan322,deltamax322,phi322,mix322,x_bdf));
t=1:length(x_bdf);
...
for k=1:32,
    ...
    x_bdf(k,:)=x_bdf(k,:).*sin(2*pi*fc322(k).*t./Fs + rand(1)*2*pi)./rms;
end
