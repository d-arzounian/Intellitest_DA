function create_param3(nbch,wide) 

% fonction permettant de générer un vocodeur de gammatone. 
% entrer dans commande matlab 
% create_param2(nb de filtres d'analyses;largeur des filtres). 
% NB: pour un banc de 32 gammatones, filtres de largeur 1ERB
% soit 16 gamma ==> 2 ERB; 8 gamma ==> 4 ERB; 4 gamma ==> 8 ERB
% retourne les fc1 = fréquences centrales des gammatones (80<x<8k Hz environ)
% fb1= bandes passantes des filtres
...
save filterparam3.mat -struct Param;
