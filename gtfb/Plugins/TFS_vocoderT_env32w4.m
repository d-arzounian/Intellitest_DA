function y=TFS_vocoderT_env32w4(x)
...
%%%vocoder 32
x_bdf=gammafilter(y,Den324,Num324,32);
x_bdf=real(gammasynth_m(deltan324,deltamax324,phi324,mix324,x_bdf));
t=1:length(x_bdf);
...
for k=1:32,
    ...
    x_bdf(k,:)=x_bdf(k,:).*sin(2*pi*fc324(k).*t./Fs + rand(1)*2*pi)./rms;
end
