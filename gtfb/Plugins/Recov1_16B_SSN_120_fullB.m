% function [out, varargout]=Recov1_16B_SSN_120(x)
...
cd 'C:\Users\Nicolas\Documents\Master Audiologie\M1\Semestre 1\Cours\Acoustique Physiologique\Projet tutoré\'TFScreator''
[x, Fs, bits] = wavread ('ajaja1a');% si valeur su volet déroulant = 2; fixe niv. stim à 60dB 
wavplay(handles.s, handles.Fe);
