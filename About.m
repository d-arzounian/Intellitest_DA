...
% Last Modified by GUIDE v2.5 22-Jan-2008 16:37:38
...
% and questIconMap
%load cnrs.png
[IconData,IconCMap] = imread('cnrs.png');
...
[IconData2,IconCMap2] = imread('Logo_Neurelec.png');
Img=image(IconData2, 'Parent', handles.axes2);
set(handles.figure1, 'Colormap', IconCMap2);
set(handles.axes2, ...
    'Visible', 'off', ...
    'YDir'   , 'reverse'       , ...
    'XLim'   , get(Img,'XData'), ...
